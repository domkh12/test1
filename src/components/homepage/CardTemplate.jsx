...
function CardTemplate({type,image}) {
  return (
    <div>
      <div className="bg-gray-200 hover:bg-white transition-all xl:w-[500px]  rounded-md h-auto p-4 flex flex-col justify-between gap-3 group">
        ...
        <div className="flex justify-between bg-white py-3 rounded-md items-center px-4">
